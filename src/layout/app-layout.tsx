...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['portfolio-owner', '3-d-designer', 'college-admissions-officer', 'system-administrator'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'D Model', path: '/d-models', entity: 'd_model', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Comment',
      path: '/comments',
      entity: 'comment',
